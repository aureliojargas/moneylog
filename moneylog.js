...
var i18nDatabase = {
	...
	es: {
		...
		helpEdit: 'Abre el editor de transacciones para incluir/eliminar/editar los datos de un extracto.',
		helpClose: 'Cierra el editor de transacciones (solo cierra, no guarda los cambios!).',
